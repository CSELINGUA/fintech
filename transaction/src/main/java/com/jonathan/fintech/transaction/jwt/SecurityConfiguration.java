package com.jonathan.fintech.transaction.jwt;

import com.jonathan.fintech.transaction.filter.JwtFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.userDetailsService(securityConfigurationService);
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf()
                .disable()
                .authorizeRequests()
                .antMatchers("/transaction/authenticate")
                .permitAll()
                .anyRequest()
                .authenticated()
                .and()
